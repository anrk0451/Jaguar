...
namespace Brown
{
    static class SqlAssist
    {
        ...
        public static void ConnectDb()
        {
            ...
            //conn = new OracleConnection("Password=bestunion;User ID=Brown;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.1.80)(PORT=1521)))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=orcl)))");
            try
            {
                conn.Open();
            }
