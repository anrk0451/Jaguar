namespace Brown.Forms
{
    partial class Frm_registerOut
    {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Frm_registerOut));
			...
			this.txtEdit_oc004 = new DevExpress.XtraEditors.ButtonEdit();
			this.te_oc005 = new DevExpress.XtraEditors.TextEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.te_oc005.Properties)).BeginInit();
			this.SuspendLayout();
			// 
			// labelControl1
			// 
			...
			// lc_3
			// 
			this.lc_3.Appearance.Image = null;
			...
			// lc_2
			// 
			this.lc_2.Appearance.Image = null;
			...
			// lc_1
			// 
			this.lc_1.Appearance.Image = null;
			...
			this.groupControl2.Controls.Add(this.txtEdit_oc003);
			this.groupControl2.Controls.Add(this.labelControl4);
			this.groupControl2.Controls.Add(this.labelControl5);
			this.groupControl2.Controls.Add(this.txtEdit_oc004);
			...
			((System.ComponentModel.ISupportInitialize)(this.te_oc005.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.TextEdit te_oc005;
		private DevExpress.XtraEditors.ButtonEdit txtEdit_oc004;
	}
}