namespace Brown.BusinessObject
{
    partial class Register_brow
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Register_brow));
			...
			this.combo_days = new DevExpress.XtraBars.BarEditItem();
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "条件查询";
			...
			// barEditItem1
			// 
			this.barEditItem1.Caption = "记录范围";
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.Width, this.combo_days, "", false, true, true, 171),
            new DevExpress.XtraBars.LinkPersistInfo(this.barStaticItem1),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.Width, this.te_quicksearch, "", false, true, true, 129)});
			...
			// barButtonItem4
			// 
			this.barButtonItem4.Caption = "原始寄存";
			...
			// barButtonItem16
			// 
			this.barButtonItem16.Caption = "寄存时间修正";
			...
			// barButtonItem6
			// 
			this.barButtonItem6.Caption = "位置变更";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "缴费";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "迁出";
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "寄存证";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "寄存标签";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "缴费记录";
			...
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "条件查询";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "导出";
			...
			// combo_days
			// 
			this.combo_days.Caption = "barEditItem2";
			this.combo_days.Edit = this.repositoryItemComboBox2;
			this.combo_days.EditValue = "今日登记";
			this.combo_days.Id = 17;
			this.combo_days.Name = "combo_days";
			this.combo_days.EditValueChanged += new System.EventHandler(this.combo_days_EditValueChanged);
			// 
			...
			this.te_quicksearch.Id = 24;
			this.te_quicksearch.Name = "te_quicksearch";
			toolTipItem1.Text = "快速查找（可按位置号、姓名或寄存证号查找）";
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1534, 34);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1534, 34);
            ...
            this.lookup_ac052,
            this.lookup_ac100});
			this.gridControl1.Size = new System.Drawing.Size(1534, 518);
			...
			this.Name = "Register_brow";
			this.Size = new System.Drawing.Size(1534, 552);
			this.Load += new System.EventHandler(this.Register_brow_Load);
        ...
        private DevExpress.XtraBars.BarEditItem combo_days;
