namespace Jaguar.BusinessObject
{
    partial class FinanceDaySearch
    {
        ...
        private void InitializeComponent()
        {
			...
			this.bBi_remove = new DevExpress.XtraBars.BarButtonItem();
			this.bBi_refund = new DevExpress.XtraBars.BarButtonItem();
			...
			this.bsm_invlog = new DevExpress.XtraBars.BarSubItem();
			...
			this.toggle_onlyme = new DevExpress.XtraBars.BarToggleSwitchItem();
            ...
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.bBi_bk, "", true, true, true, 0, null, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.bBi_remove, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.bBi_refund, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.barSubItem1, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            new DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, this.bsm_invlog, "", true, true, true, 0, null, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph),
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.toggle_onlyme)});
			this.bar1.Text = "工具";
			// 
			// barButtonItem1
			// 
			...
			// bBi_bk
			// 
			this.bBi_bk.Caption = "补开发票";
			this.bBi_bk.Id = 1;
			this.bBi_bk.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("bBi_bk.ImageOptions.SvgImage")));
			this.bBi_bk.Name = "bBi_bk";
			this.bBi_bk.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.barButtonItem2_ItemClick);
			// 
			// bBi_remove
			// 
			this.bBi_remove.Caption = "作废";
			this.bBi_remove.Id = 2;
			this.bBi_remove.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("bBi_remove.ImageOptions.SvgImage")));
			this.bBi_remove.Name = "bBi_remove";
			this.bBi_remove.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.bBi_remove_ItemClick);
			// 
			// bBi_refund
			// 
			this.bBi_refund.Caption = "退费";
			this.bBi_refund.Enabled = false;
			this.bBi_refund.Id = 11;
			this.bBi_refund.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("bBi_refund.ImageOptions.Image")));
			this.bBi_refund.ImageOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("bBi_refund.ImageOptions.LargeImage")));
			this.bBi_refund.Name = "bBi_refund";
			this.bBi_refund.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.bBi_refund_ItemClick);
			// 
			// barSubItem1
			// 
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "财政发票";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "税务发票";
			...
			// barButtonItem9
			// 
			this.barButtonItem9.Caption = "税票清单";
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "销售项目清单";
			...
			// barButtonItem2
			// 
			this.barButtonItem2.Caption = "火化证明";
			...
			// bsm_invlog
			// 
			this.bsm_invlog.Caption = "日志维护";
			this.bsm_invlog.Id = 17;
			this.bsm_invlog.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("bsm_invlog.ImageOptions.SvgImage")));
			this.bsm_invlog.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem3),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem10),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem12, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.barButtonItem14)});
			this.bsm_invlog.Name = "bsm_invlog";
			// 
			// barButtonItem3
			// 
			this.barButtonItem3.Caption = "查找下一个";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "补充日志";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "作废单边发票";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "税务项目冲红";
			...
			this.toggle_onlyme.Id = 10;
			this.toggle_onlyme.Name = "toggle_onlyme";
			this.toggle_onlyme.CheckedChanged += new DevExpress.XtraBars.ItemClickEventHandler(this.toggle_onlyme_CheckedChanged);
			// 
			// barDockControlTop
			// 
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1369, 34);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1369, 34);
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "财政发票";
			...
			// bBi_log
			// 
			this.bBi_log.Caption = "日志维护";
			this.bBi_log.Id = 16;
			this.bBi_log.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("bBi_log.ImageOptions.SvgImage")));
			...
			this.tabPane1.RegularSize = new System.Drawing.Size(1369, 584);
			this.tabPane1.SelectedPage = this.tabNavigationPage1;
			this.tabPane1.Size = new System.Drawing.Size(1369, 584);
			...
			// tabNavigationPage1
			// 
			this.tabNavigationPage1.Caption = "按笔显示";
			...
			this.tabNavigationPage1.Size = new System.Drawing.Size(1369, 558);
			// 
			...
			this.splitContainerControl1.Size = new System.Drawing.Size(1369, 558);
			...
			this.gridControl1.Size = new System.Drawing.Size(1369, 365);
            ...
            this.gridColumn3,
            this.gridColumn31});
			this.gridView1.DetailHeight = 291;
			...
			this.gridControl2.Size = new System.Drawing.Size(1369, 186);
            ...
            this.gridColumn33,
            this.gridColumn34});
			this.gridView2.DetailHeight = 291;
			...
			// gridColumn33
			// 
			this.gridColumn33.Caption = "减免金额";
			...
			this.gridColumn33.FieldName = "AVOIDFEE";
			...
			// gridColumn34
			// 
			this.gridColumn34.Caption = "实际金额";
			...
			this.gridColumn34.FieldName = "ACTUALFEE";
			...
			// tabNavigationPage2
			// 
			this.tabNavigationPage2.Caption = "按发票显示";
			...
			this.tabNavigationPage2.Margin = new System.Windows.Forms.Padding(4, 2, 4, 2);
			this.tabNavigationPage2.Name = "tabNavigationPage2";
			this.tabNavigationPage2.Properties.ShowMode = DevExpress.XtraBars.Navigation.ItemShowMode.ImageAndText;
			this.tabNavigationPage2.Size = new System.Drawing.Size(1369, 560);
			// 
			...
			this.splitContainerControl2.Size = new System.Drawing.Size(1369, 560);
			...
			this.gridControl3.Size = new System.Drawing.Size(1369, 401);
            ...
            this.gridColumn30,
            this.gridColumn32});
			this.gridView3.DetailHeight = 291;
			this.gridView3.GridControl = this.gridControl3;
			this.gridView3.IndicatorWidth = 44;
			...
			this.gridColumn30.MinWidth = 149;
			this.gridColumn30.Name = "gridColumn30";
			this.gridColumn30.Visible = true;
			this.gridColumn30.VisibleIndex = 3;
			this.gridColumn30.Width = 228;
			// 
			// gridColumn32
			// 
			...
			this.gridControl4.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(4, 2, 4, 2);
			this.gridControl4.Location = new System.Drawing.Point(0, 0);
			this.gridControl4.MainView = this.gridView4;
			this.gridControl4.Margin = new System.Windows.Forms.Padding(4, 2, 4, 2);
			this.gridControl4.MenuManager = this.barManager1;
			this.gridControl4.Name = "gridControl4";
			this.gridControl4.Size = new System.Drawing.Size(1369, 152);
            ...
            this.gridColumn27,
            this.gridColumn28});
			this.gridView4.DetailHeight = 291;
			...
			this.gridView4.ViewCaption = "发票明细";
			// 
			// gridColumn6
			// 
        ...
        private DevExpress.XtraBars.BarButtonItem bBi_bk;
        private DevExpress.XtraBars.BarButtonItem bBi_remove;
        ...
        private DevExpress.XtraBars.BarToggleSwitchItem toggle_onlyme;
        ...
        private DevExpress.XtraBars.BarButtonItem bBi_refund;
        ...
        private DevExpress.XtraBars.BarSubItem bsm_invlog;
