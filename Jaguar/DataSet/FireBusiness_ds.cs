...
namespace Jaguar.DataSet
{
	class FireBusiness_ds : System.Data.DataSet
	{
		...
		public FireBusiness_ds()
		{
			...
			DataColumn col_avoid = new DataColumn("AVOIDFEE", typeof(decimal));  // 减免金额
			DataColumn col_actual = new DataColumn("ACTUALFEE", typeof(decimal));// 实际金额		
			...
			DataColumn col_sa222 = new DataColumn("SA222", typeof(string));    // 冲红标志
			...
			Sa01.Columns.AddRange(new DataColumn[] { col_sa001,col_ac001,col_sa002,col_sa003,col_sa004,col_sa005,col_price,col_nums,col_sa007,col_sa006,
				col_sa008,col_sa010,col_sa100,col_status,col_sa020,col_sa025,col_avoid,col_actual,col_sa222
			});
