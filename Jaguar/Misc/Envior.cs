...
namespace Jaguar.Misc
{
	class Envior
	{
        ...
        public static string TAX_CERT_PWD { get; set; }       //税务金税卡密码
        public static string TAX_CODE_VER { get; set; }       //税收分类编码版本 
        public static bool TAX_READY { get; set; }            //税务金税卡状态
        ...
        public static string REG_CHOOSE_MODE { get; set; }       //寄存选号方式
	}
}
